...
import StringIO
import unittest
import random  # Acceptance generation
...
# Used to pipe random ranges for acceptance to a file
# Uncomment lines 206-207 to reenable use

#for x in range(0, 2000) :
#	print str(random.randrange(1, 100000)) + " " + str(random.randrange(1, 100000))
